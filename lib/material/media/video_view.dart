...
// import 'package:thoad/core/utils/extensions/tap_ext.dart';
// import 'package:thoad/core/utils/extensions/widget_ext.dart';
...
//         if (snapshot.connectionState == ConnectionState.done && videoController != null && snapshot.hasError == false) {
//           child = ValueListenableBuilder(
//             valueListenable: videoController,
//             child: VideoPlayer(videoController),
//             builder: (context, playerValue, child) {
//               final progressValue = (playerValue.position.inMilliseconds / playerValue.duration.inMilliseconds).sign;
//               return AspectRatio(
//                 aspectRatio: 16 / 9,
//                 child: Stack(
...
//           ).withPadding(all: 20).withRadius(radius: 8),
//         BackdropFilter(
