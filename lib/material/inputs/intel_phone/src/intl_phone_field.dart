...
class _IntlPhoneField extends StatefulWidget {
  ...
  ///
  /// When null, the invalid-number message comes from app localizations.
    ...
    await showAppModalBottomSheet(
      ...
      child: StatefulBuilder(
        builder: (ctx, setState) => CountryPickerSheet(
          ...
          searchText: widget.searchText.isNotEmpty
              ? widget.searchText
              : appLocalizer.materialPhoneSearchCountry,
  ...
  String? _validatorFun(String? number) {
    ...
    if (value == '') {
      ...
      if (!(value.length >= _selectedCountry.minLength &&
          value.length <= _selectedCountry.maxLength)) {
        return widget.invalidNumberMessage ?? appLocalizer.materialPhoneInvalid;
