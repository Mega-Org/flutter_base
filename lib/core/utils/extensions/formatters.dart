...
/// [NoStartWithZeroFormatter] This Formatter Deny zero at the start
class NoStartWithZeroFormatter extends TextInputFormatter {
  @override
  TextEditingValue formatEditUpdate(
    TextEditingValue oldValue,
    TextEditingValue newValue,
...
class AlwaysUpperCaseInputFormatter extends TextInputFormatter {
  @override
  TextEditingValue formatEditUpdate(
    TextEditingValue oldValue,
    TextEditingValue newValue,
...
class CurrencyInputFormatter extends TextInputFormatter {
  final intl.NumberFormat currencyFormat = intl.NumberFormat("#,###", "ar");
  final String currencySuffix = appLocalizer.riyal;
  ...
  TextEditingValue formatEditUpdate(
    ...
    final int newCursorOffset = _calculateCursorOffset(
      oldValue,
      newValue,
      formattedNumber,
    );
  ...
  int _calculateCursorOffset(
    ...
    int digitsSeen = 0;
    while (cursorInFormatted < formattedNumber.length &&
