        ...
        children: [
          if (canPickImage)
            _TileWidget(
              ...
              icon: Icons.image,
              // svgIcon: AppIcons.galleryFillIc,
              onTap: () async {
          ...
          if (canPickVideo)
            _TileWidget(
              // svgIcon: AppIcons.videoSquareFillIc,
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // //     ),
              // //     child: AppSvgIcon(path: svgIcon ?? '', size: 20),
              // //   )
              // else
